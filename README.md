...
* Note that upgrading from Debian 10 to 12 requires that the METplus [runtime environments](https://github.com/dtcenter/METplus/tree/main_v5.1/internal/scripts/docker_env) also be upgraded to Debian 12.
